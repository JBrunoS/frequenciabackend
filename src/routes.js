...
routes.get(
  "/projeto/:id_projeto/:faixa/:tipo_programa",
  participanteController.getByAtendimentoProjeto,
);
routes.get(
  "/lar/:id_projeto/:tipo_programa",
  participanteController.getByAtendimentoLar,
);
routes.put(
  "/edit_faixa/:id_user/:id_projeto/:faixa",
  participanteController.updateFaixa,
);
routes.put(
  "/saldo/participantes",
...
routes.get(
  ...
  professorController.getProfessoresAtivos,
);
...
routes.get(
  "/professor/turmas/:id_professor/:id_projeto",
  turmaController.getTurmaByProfessor,
);
routes.get(
  "/turma/:id_projeto/:nome_turma/:turno_turma",
  turmaController.getTurmaByNameTurno,
);
routes.get(
...
routes.get(
  ...
  turmaController.getParticipanteSemTurmaProjeto,
);
routes.get(
  "/participantes/:id_projeto/:nome_turma/:tipo_programa",
  turmaController.getParticipanteSemTurmaLar,
);
routes.post("/add/turma", turmaController.adicionaParticipanteSemTurma);
routes.delete(
  "/delete/:id_participante/:id_projeto/:nome_turma",
  turmaController.deleteParticipantesdaTurma,
);
...
routes.get(
  "/geral/frequencia/dias/:id_projeto/:nome_turma/:mes_turma/:ano_turma/:turno_turma",
  frequenciaController.getFrequenciaGeralDiasTurno,
);
routes.get(
  "/geral/frequencia/:id_projeto/:nome_turma/:mes_turma/:ano_turma",
  frequenciaController.getFrequenciaGeral,
);
routes.get(
  "/geral/frequencia/:id_projeto/:nome_turma/:mes_turma/:ano_turma/:turno_turma",
  frequenciaController.getFrequenciaGeralTurnos,
);
// routes.get('/get/faltas/:id_projeto', frequenciaController.getFaltasDeAlunos)
routes.get(
  "/get/frequencia/:id_projeto/:nome_turma/:turno_turma/:mes_turma/:ano_turma",
  frequenciaController.getFrequenciaPorMesEAno,
);
routes.get(
  "/get/frequencia/:id_projeto/:nome_turma/:turno_turma/:mes_turma/:ano_turma/:dia_turma",
  frequenciaController.getFrequenciaPorDia,
);
routes.get(
  "/get/frequencia-aluno/:id_participante/:mes_turma/:ano_turma",
  frequenciaController.getFrequenciaPorAluno,
);
// routes.get('/get/balanco_ausentes/:id_projeto/:nome_turma/:mes/:ano/:dia', frequenciaController.getAusentes)
routes.post(
  "/create/frequencia/sementinha",
  frequenciaController.createFrequenciaSementinha,
);
routes.get(
  "/get/frequencia/:id_projeto/:nome_turma/:turno_turma",
  frequenciaController.index,
);
routes.get(
  "/get/geral/:id_projeto/:mes_turma/:ano_turma",
  frequenciaController.geral,
);
routes.get(
  "/dashboard/frequencia-turmas/:id_projeto/:mes/:ano",
  frequenciaController.frequenciaTurmas,
);
...
routes.post(
  "/atualiza-estoque/:id_projeto",
  estoqueController.atualizaQuantidade,
);
...
routes.get(
  "/vendedor/sorteio/:id_professor",
  sorteioController.getTotalPontosColaborador,
);
routes.get("/vendedor/nomes/:id_professor", sorteioController.index);
routes.get(
  "/vendedores/:id_projeto/:status",
  sorteioController.getTotalPontosVendedores,
);
