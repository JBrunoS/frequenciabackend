...
module.exports = {
    ...
    async atualizaIndividual(req, res) {
        ...
        if (result) {
            ...
            return res.json('LanÃ§ado com sucesso!')
        } else {
            return res.json(`Desculpe, nÃ£o foi possÃ­vel alterar. Ã‰ necessÃ¡rio que se faÃ§a uma reposiÃ§Ã£o geral antes.`)
        }
    ...
    async registraGastos(req, res) {
        ...
        if (mes_compra != mes || ano_compra != ano) {
            return res.json('SÃ³ Ã© possÃ­vel lanÃ§ar valores no mÃªs e ano atual.')
        }
        ...
        if (result) {
            return res.json(`JÃ¡ foi lanÃ§ado uma alteraÃ§Ã£o de valor do ${area} nesse mÃªs. Favor, alterar de forma individual.`)
        } else {
            ...
            return res.json(`Valor lanÃ§ado com sucesso para ${area} - CÃ³digo: ${novo}`)
        }
    },
    ...
    async atualizaQuantidade(req, res) {
        ...
        if (resultGastos && !resultEstoque) {
            ...
            return res.json('ReposiÃ§Ã£o de estoque feito com sucesso!')
        }
 
        return res.json(`NÃ£o foi possÃ­vel cadastrar, reposiÃ§Ã£o jÃ¡ feita no mÃªs ${mes}. Caso seja necessÃ¡rio, fazer a alteraÃ§Ã£o de forma individual.`)
    },
